...
public class PantallaPrincipal extends JFrame {
    ...
    private void showDashboardPanel() {
        ...
        JLabel lblSubWelcome = new JLabel("<html>Seleccione una opción del menú lateral para comenzar a gestionar su inventario y ventas.</html>");
        ...
        statsPanel.add(createStatCard("Productos", "120", "Artículos en stock"));
        statsPanel.add(createStatCard("Ventas del Día", "8", "Total: Q1,200.00"));
        statsPanel.add(createStatCard("Clientes", "45", "Registrados"));
        statsPanel.add(createStatCard("Categorías", "7", "De productos"));
    ...
    private void showProductosPanel() {
        ...
        // Aquí crearías e insertarías tu panel de gestión de productos
        // Por ahora, mostraremos un mensaje de "en construcción"
        JPanel constructionPanel = createConstructionPanel("Gestión de Productos", 
            "<html>Aquí podrás administrar tu inventario de globos.<br>"
            + "• Ver stock disponible<br>"
            + "• Añadir nuevos productos<br>"
            + "• Actualizar precios<br>"
            + "• Gestionar categorías</html>");
